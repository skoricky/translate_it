...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.saveToolButton.setToolTip("Сохранить")
        ...
        self.exitToolButton.setToolTip("Выход")
        ...
        self.deleteTrigger = QtWidgets.QAction(MainWindow)
        self.deleteTrigger.setObjectName("deleteTrigger")
        ...
        self.menu.addAction(self.deleteTrigger)
        self.menu.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deleteTrigger.setText(_translate("MainWindow", "Удалить"))
